        ...
        <div>
            ...
            >
                <div className="flex gap-4 sm:gap-5 items-start flex-wrap">
                    <div
                        className="flex-none grid place-items-center rounded-2xl text-[var(--primary-foreground)]"
                        style={{ width: 76, height: 76, background: "linear-gradient(150deg,oklch(0.78 0.16 162),oklch(0.5 0.11 160))" }}
                    >
                ...
                <div className="flex gap-2.5 mt-5 flex-wrap items-center">
                    <button
                        type="button"
                        onClick={onPlanWeek}
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[var(--primary)] text-[var(--primary-foreground)] font-bold text-sm cursor-pointer hover:brightness-110 transition"
                    >
